...
type TCreateNewPasswordStepProps = {
  handleNextStep: () => void;
};

function CreateNewPassword({ handleNextStep }: TCreateNewPasswordStepProps) {
  const submitHandler = () => {
  ...
  return (
    <StepLayout title="Create New Password" nextStepHandler={submitHandler}>
